...
func Example() {
	...
	fmt.Println(Button.Classes(ButtonProps{Size: "medium", Style: "primary"}))
	fmt.Println(Button.Classes(ButtonProps{Size: "small", Style: "secondary"}))
	fmt.Println(Button.Classes(ButtonProps{Size: "large", Style: "outline"}))
	fmt.Println()

	// Loading button examples
	fmt.Println("Loading Button Examples:")
	fmt.Println(LoadingButton.Classes(LoadingButtonProps{
	...
	fmt.Println(IconButton.Classes(IconButtonProps{
		ButtonProps: ButtonProps{Size: "medium", Style: "primary"},
		Icon:        "plus",
	}))
	fmt.Println(IconButton.Classes(IconButtonProps{
